      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="order-2 lg:order-1">
            ...
            >
              Un kit completo di Schema Therapy per psicologi e psicoterapeuti, con pagine teoriche introduttive.
            </p>
            <p
            ...
            >
              ...
              <span className="text-[#8b5a3c] font-medium"> 54 immagini</span> fronte-retro in cartoncino plastificato.
            </p>
