  ...
  return (
    <div id="top" className="min-h-screen bg-[#f8f5f0]">
      ...
      <a
        ...
        target="_blank"
        rel="noreferrer"
        className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 rounded-full bg-[#25D366] text-white shadow-lg shadow-black/30 hover:bg-[#22c25c] transition"
